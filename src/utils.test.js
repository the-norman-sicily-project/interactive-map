import { ddToDms, getDms, startCaseTerm, startCaseList, getListOfOrders, orderLookup } from './utils';

describe('orderLookup', () => {
    it('return white for an unknown order', () => {
...
describe('getListOfOrders', () => {
    ...
    it('should sort the list orf orders', () => {
        const list = [{ properties: { order: 'quux' } }, { properties: { order: 'foo' } }, { properties: { order: 'bar' } }];
